...
$docker_ps = @("social", "pa-gateway", "prism-proxy", "couchdb_init", "share-proxy", "share-platform", "prism-platform", "mongo", "share-app", "prism-app", "welcome", "neo-idviz", "neo-provision", "couchdb", "cdn3p", "wa-proxy", "bss", "glass", "user-admin", "redis", "admintool")
$logfile =  "D:\Utils\Logs\Docker_container_monitor.txt"
$start_count = "4"
$iter - "0"
$recipients = @("ILMN-Role-Cognos-Administrators@illumina.com", "pgundeti@illumina.com", "pchakravarthula@illumina.com", "aagrawal2@illumina.com")
